...
namespace Framework.Web
{
    ...
    public static class DataGridExtentions
    {
        ...
        /// <summary>
        /// Gets or sets a data item associated with the System.Web.UI.WebControls.DataGridItem object in the System.Web.UI.WebControls.Repeater control.
        /// </summary>
        /// <typeparam name="T">paramtype</typeparam>
        /// <param name="e">RepeaterItemEventArgs</param>
        /// <returns></returns>
        public static T CastTo<T>(this DataGridItemEventArgs @e) where T:class, new()
        {
        ...
        public static WebControl GetControl<T>(this DataGridItemEventArgs @e, string id) where T : WebControl
        {
        ...
        public static bool IsListItem(this DataGridItemEventArgs @e)
        {
        ...
        /// <param name="e">RepeaterItemEventArgs</param>
        /// <returns>bool</returns>
        public static bool IsFooter(this DataGridItemEventArgs @e)
        {
        ...
        /// <param name="e">RepeaterItemEventArgs</param>
        /// <returns>bool</returns>
        public static bool IsHeader(this DataGridItemEventArgs @e)
        {
